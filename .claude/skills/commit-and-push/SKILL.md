...
2. **Commit** with a clear, concise message following the [Conventional Commits](https://www.conventionalcommits.org/) standard (e.g., `feat(loader): implement DosSetFilePtr`). The message should explain *why* the change was made, not just *what* changed. Append a co-author trailer:
   ```
