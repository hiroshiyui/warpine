...
cargo test                               # Unit tests (351 tests: LX/NE parsers, VFS, managers, MMPM, API registry, HeadlessRenderer, scan codes, text renderer, DLL loader, crash dump, API ring buffer, GPI, PM controls, codepage, INITTERM, DosMapCase) + 9 integration tests
