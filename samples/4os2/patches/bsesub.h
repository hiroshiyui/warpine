...
USHORT _System KbdCharIn(PKBDKEYINFO,USHORT,HKBD);
USHORT _System KbdClose(HKBD);
USHORT _System KbdDeRegister(VOID);
USHORT _System KbdFlushBuffer(HKBD);
USHORT _System KbdFreeFocus(HKBD);
USHORT _System KbdGetCp(ULONG,PUSHORT,HKBD);
USHORT _System KbdGetFocus(USHORT,HKBD);
USHORT _System KbdGetHWId(PKBDHWID,HKBD);
USHORT _System KbdGetStatus(PKBDINFO,HKBD);
USHORT _System KbdOpen(PHKBD);
USHORT _System KbdPeek(PKBDKEYINFO,HKBD);
USHORT _System KbdRegister(PSZ,PSZ,ULONG);
USHORT _System KbdSetCp(USHORT,USHORT,HKBD);
USHORT _System KbdSetCustXt(PUSHORT,HKBD);
USHORT _System KbdSetFgnd(VOID);
USHORT _System KbdSetStatus(PKBDINFO,HKBD);
USHORT _System KbdStringIn(PCH,PSTRINGINBUF,USHORT,HKBD);
USHORT _System KbdSynch(USHORT);
USHORT _System KbdXlate(PKBDTRANS,HKBD);
...
USHORT _System MouClose(HMOU);
USHORT _System MouDeRegister(VOID);
USHORT _System MouDrawPtr(HMOU);
USHORT _System MouFlushQue(HMOU);
USHORT _System MouGetDevStatus(PUSHORT,HMOU);
USHORT _System MouGetEventMask(PUSHORT,HMOU);
USHORT _System MouGetNumButtons(PUSHORT,HMOU);
USHORT _System MouGetNumMickeys(PUSHORT,HMOU);
USHORT _System MouGetNumQueEl(PMOUQUEINFO,HMOU);
USHORT _System MouGetPtrPos(PPTRLOC,HMOU);
USHORT _System MouGetPtrShape(PBYTE,PPTRSHAPE,HMOU);
USHORT _System MouGetScaleFact(PSCALEFACT,HMOU);
USHORT _System MouInitReal(PSZ);
USHORT _System MouOpen(PSZ,PHMOU);
USHORT _System MouReadEventQue(PMOUEVENTINFO,PUSHORT,HMOU);
USHORT _System MouRegister(PSZ,PSZ,ULONG);
USHORT _System MouRemovePtr(PNOPTRRECT,HMOU);
USHORT _System MouSetDevStatus(PUSHORT,HMOU);
USHORT _System MouSetEventMask(PUSHORT,HMOU);
USHORT _System MouSetPtrPos(PPTRLOC,HMOU);
USHORT _System MouSetPtrShape(PBYTE,PPTRSHAPE,HMOU);
USHORT _System MouSetScaleFact(PSCALEFACT,HMOU);
USHORT _System MouSynch(USHORT);
...
USHORT _System VioDeRegister(VOID);
USHORT _System VioEndPopUp(HVIO);
USHORT _System VioGetAnsi(PUSHORT,HVIO);
USHORT _System VioGetBuf(PULONG,PUSHORT,HVIO);
USHORT _System VioGetConfig(USHORT,PVIOCONFIGINFO,HVIO);
USHORT _System VioGetCp(USHORT,PUSHORT,HVIO);
USHORT _System VioGetCurPos(PUSHORT,PUSHORT,HVIO);
USHORT _System VioGetCurType(PVIOCURSORINFO,HVIO);
USHORT _System VioGetFont(PVIOFONTINFO,HVIO);
USHORT _System VioGetMode(PVIOMODEINFO,HVIO);
USHORT _System VioGetPhysBuf(PVIOPHYSBUF,USHORT);
USHORT _System VioGetState(PVOID,HVIO);
USHORT _System VioGlobalReg(PSZ,PSZ,ULONG,ULONG,LONG);
USHORT _System VioModeUndo(USHORT,USHORT,USHORT);
USHORT _System VioModeWait(USHORT,PUSHORT,USHORT);
USHORT _System VioPopUp(PUSHORT,HVIO);
USHORT _System VioPrtSc(HVIO);
USHORT _System VioPrtScToggle(HVIO);
USHORT _System VioReadCellStr(PCH,PUSHORT,USHORT,USHORT,HVIO);
USHORT _System VioReadCharStr(PCH,PUSHORT,USHORT,USHORT,HVIO);
USHORT _System VioRegister(PSZ,PSZ,ULONG,ULONG);
USHORT _System VioSavRedrawUndo(USHORT,USHORT,HVIO);
USHORT _System VioSavRedrawWait(USHORT,PUSHORT,HVIO);
USHORT _System VioScrLock(USHORT,PUCHAR,HVIO);
USHORT _System VioScrollDn(USHORT,USHORT,USHORT,USHORT,USHORT,PBYTE,HVIO);
USHORT _System VioScrollLf(USHORT,USHORT,USHORT,USHORT,USHORT,PBYTE,HVIO);
USHORT _System VioScrollRt(USHORT,USHORT,USHORT,USHORT,USHORT,PBYTE,HVIO);
USHORT _System VioScrollUp(USHORT,USHORT,USHORT,USHORT,USHORT,PBYTE,HVIO);
USHORT _System VioScrUnLock(HVIO);
USHORT _System VioSetAnsi(USHORT,HVIO);
USHORT _System VioSetCp(USHORT,USHORT,HVIO);
USHORT _System VioSetCurPos(USHORT,USHORT,HVIO);
USHORT _System VioSetCurType(PVIOCURSORINFO,HVIO);
USHORT _System VioSetFont(PVIOFONTINFO,HVIO);
USHORT _System VioSetMode(PVIOMODEINFO,HVIO);
USHORT _System VioSetState(PVOID,HVIO);
USHORT _System VioShowBuf(USHORT,USHORT,HVIO);
USHORT _System VioWrtCellStr(PCH,USHORT,USHORT,USHORT,HVIO);
USHORT _System VioWrtCharStr(PCH,USHORT,USHORT,USHORT,HVIO);
USHORT _System VioWrtCharStrAtt(PCH,USHORT,USHORT,USHORT,PBYTE,HVIO);
USHORT _System VioWrtNAttr(PBYTE,USHORT,USHORT,USHORT,HVIO);
USHORT _System VioWrtNCell(PBYTE,USHORT,USHORT,USHORT,HVIO);
USHORT _System VioWrtNChar(PBYTE,USHORT,USHORT,USHORT,HVIO);
USHORT _System VioWrtTTY(PCH,USHORT,HVIO);
