...
USHORT _Pascal KbdCharIn(PKBDKEYINFO,USHORT,HKBD);
USHORT _Pascal KbdClose(HKBD);
USHORT _Pascal KbdDeRegister(VOID);
USHORT _Pascal KbdFlushBuffer(HKBD);
USHORT _Pascal KbdFreeFocus(HKBD);
USHORT _Pascal KbdGetCp(ULONG,PUSHORT,HKBD);
USHORT _Pascal KbdGetFocus(USHORT,HKBD);
USHORT _Pascal KbdGetHWId(PKBDHWID,HKBD);
USHORT _Pascal KbdGetStatus(PKBDINFO,HKBD);
USHORT _Pascal KbdOpen(PHKBD);
USHORT _Pascal KbdPeek(PKBDKEYINFO,HKBD);
USHORT _Pascal KbdRegister(PSZ,PSZ,ULONG);
USHORT _Pascal KbdSetCp(USHORT,USHORT,HKBD);
USHORT _Pascal KbdSetCustXt(PUSHORT,HKBD);
USHORT _Pascal KbdSetFgnd(VOID);
USHORT _Pascal KbdSetStatus(PKBDINFO,HKBD);
USHORT _Pascal KbdStringIn(PCH,PSTRINGINBUF,USHORT,HKBD);
USHORT _Pascal KbdSynch(USHORT);
USHORT _Pascal KbdXlate(PKBDTRANS,HKBD);
...
USHORT _Pascal MouClose(HMOU);
USHORT _Pascal MouDeRegister(VOID);
USHORT _Pascal MouDrawPtr(HMOU);
USHORT _Pascal MouFlushQue(HMOU);
USHORT _Pascal MouGetDevStatus(PUSHORT,HMOU);
USHORT _Pascal MouGetEventMask(PUSHORT,HMOU);
USHORT _Pascal MouGetNumButtons(PUSHORT,HMOU);
USHORT _Pascal MouGetNumMickeys(PUSHORT,HMOU);
USHORT _Pascal MouGetNumQueEl(PMOUQUEINFO,HMOU);
USHORT _Pascal MouGetPtrPos(PPTRLOC,HMOU);
USHORT _Pascal MouGetPtrShape(PBYTE,PPTRSHAPE,HMOU);
USHORT _Pascal MouGetScaleFact(PSCALEFACT,HMOU);
USHORT _Pascal MouInitReal(PSZ);
USHORT _Pascal MouOpen(PSZ,PHMOU);
USHORT _Pascal MouReadEventQue(PMOUEVENTINFO,PUSHORT,HMOU);
USHORT _Pascal MouRegister(PSZ,PSZ,ULONG);
USHORT _Pascal MouRemovePtr(PNOPTRRECT,HMOU);
USHORT _Pascal MouSetDevStatus(PUSHORT,HMOU);
USHORT _Pascal MouSetEventMask(PUSHORT,HMOU);
USHORT _Pascal MouSetPtrPos(PPTRLOC,HMOU);
USHORT _Pascal MouSetPtrShape(PBYTE,PPTRSHAPE,HMOU);
USHORT _Pascal MouSetScaleFact(PSCALEFACT,HMOU);
USHORT _Pascal MouSynch(USHORT);
...
USHORT _Pascal VioDeRegister(VOID);
USHORT _Pascal VioEndPopUp(HVIO);
USHORT _Pascal VioGetAnsi(PUSHORT,HVIO);
USHORT _Pascal VioGetBuf(PULONG,PUSHORT,HVIO);
USHORT _Pascal VioGetConfig(USHORT,PVIOCONFIGINFO,HVIO);
USHORT _Pascal VioGetCp(USHORT,PUSHORT,HVIO);
USHORT _Pascal VioGetCurPos(PUSHORT,PUSHORT,HVIO);
USHORT _Pascal VioGetCurType(PVIOCURSORINFO,HVIO);
USHORT _Pascal VioGetFont(PVIOFONTINFO,HVIO);
USHORT _Pascal VioGetMode(PVIOMODEINFO,HVIO);
USHORT _Pascal VioGetPhysBuf(PVIOPHYSBUF,USHORT);
USHORT _Pascal VioGetState(PVOID,HVIO);
USHORT _Pascal VioGlobalReg(PSZ,PSZ,ULONG,ULONG,LONG);
USHORT _Pascal VioModeUndo(USHORT,USHORT,USHORT);
USHORT _Pascal VioModeWait(USHORT,PUSHORT,USHORT);
USHORT _Pascal VioPopUp(PUSHORT,HVIO);
USHORT _Pascal VioPrtSc(HVIO);
USHORT _Pascal VioPrtScToggle(HVIO);
USHORT _Pascal VioReadCellStr(PCH,PUSHORT,USHORT,USHORT,HVIO);
USHORT _Pascal VioReadCharStr(PCH,PUSHORT,USHORT,USHORT,HVIO);
USHORT _Pascal VioRegister(PSZ,PSZ,ULONG,ULONG);
USHORT _Pascal VioSavRedrawUndo(USHORT,USHORT,HVIO);
USHORT _Pascal VioSavRedrawWait(USHORT,PUSHORT,HVIO);
USHORT _Pascal VioScrLock(USHORT,PUCHAR,HVIO);
USHORT _Pascal VioScrollDn(USHORT,USHORT,USHORT,USHORT,USHORT,PBYTE,HVIO);
USHORT _Pascal VioScrollLf(USHORT,USHORT,USHORT,USHORT,USHORT,PBYTE,HVIO);
USHORT _Pascal VioScrollRt(USHORT,USHORT,USHORT,USHORT,USHORT,PBYTE,HVIO);
USHORT _Pascal VioScrollUp(USHORT,USHORT,USHORT,USHORT,USHORT,PBYTE,HVIO);
USHORT _Pascal VioScrUnLock(HVIO);
USHORT _Pascal VioSetAnsi(USHORT,HVIO);
USHORT _Pascal VioSetCp(USHORT,USHORT,HVIO);
USHORT _Pascal VioSetCurPos(USHORT,USHORT,HVIO);
USHORT _Pascal VioSetCurType(PVIOCURSORINFO,HVIO);
USHORT _Pascal VioSetFont(PVIOFONTINFO,HVIO);
USHORT _Pascal VioSetMode(PVIOMODEINFO,HVIO);
USHORT _Pascal VioSetState(PVOID,HVIO);
USHORT _Pascal VioShowBuf(USHORT,USHORT,HVIO);
USHORT _Pascal VioWrtCellStr(PCH,USHORT,USHORT,USHORT,HVIO);
USHORT _Pascal VioWrtCharStr(PCH,USHORT,USHORT,USHORT,HVIO);
USHORT _Pascal VioWrtCharStrAtt(PCH,USHORT,USHORT,USHORT,PBYTE,HVIO);
USHORT _Pascal VioWrtNAttr(PBYTE,USHORT,USHORT,USHORT,HVIO);
USHORT _Pascal VioWrtNCell(PBYTE,USHORT,USHORT,USHORT,HVIO);
USHORT _Pascal VioWrtNChar(PBYTE,USHORT,USHORT,USHORT,HVIO);
USHORT _Pascal VioWrtTTY(PCH,USHORT,HVIO);
